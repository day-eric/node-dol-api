...
function API(key){
	...
	return {
		ouiInitialClaims:function(){
			var endPoint = 'Statistics/OUI_InitialClaims/unemploymentInsuranceInitialClaims';
			return getData(endPoint);
		},
		dolAgencies:function(){
			var endPoint = 'DOLAgency/Agencies/';
			return getData(endPoint);
		},
		metadata:function(){
			var endPoint = 'APIMetadata/APIMetadatas';
			return getData(endPoint);
		},
		forms:function(){
			var endPoint = 'FORMS';
		...
		formsAgencies:function(){
			var endPoint = 'FORMS/Agencies';
			return getData(endPoint);
		},
		formsAgencyForms:function(){
			var endPoint = 'FORMS/AgencyForms';
			return getData(endPoint);
		},
		faqTopics:function(){
			var endPoint = 'FAQ/Topics';
			return getData(endPoint);
		},
		faqSubtopics:function(){
			var endPoint = 'FAQ/SubTopics';
			return getData(endPoint);
		},
		faqQuestions:function(){
			var endPoint = 'FAQ/TopicQuestions';
			return getData(endPoint);
		},
		mspa:function(){
			var endPoint = 'MSPA/FarmLaborContractors';
			return getData(endPoint);
		},
		safetyHealthChemicalExposureInspections:function(){
			var endPoint = 'SafetyHealth/ChemicalExposureInspections';
			return getData(endPoint);
		},
		safetyHealthEstablishmentSpecificInjuryIllnessRates:function(){
			var endPoint = 'SafetyHealth/EstablishmentSpecificInjuryIllnessRates';
			return getData(endPoint);
		},
		statisticsOES2010:function(){
			var endPoint = 'Statistics/OES2010';
			return getData(endPoint);
		},
		...
		getDataFromEndpoint:function(endPoint){
//			console.log(Object.prototype.toString.call(endPoint));
...
//				console.log('instance of EndPoint');
				return getData(endPoint.uri);
			}
		},
	};
}
